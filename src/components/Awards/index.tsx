...
const Awards = ({ awards }: AwardsProps) => {
  const getAwardIcon = (type?: string) => {
    switch (type) {
      case 'award':
        return <BsAward className="text-3xl text-blue-400" />
      case 'achievement':
        return <BsTrophy className="text-3xl text-blue-400" />
      case 'certification':
        return <BsPatchCheck className="text-3xl text-blue-400" />
      default:
        return <BsTrophy className="text-3xl text-blue-400" />
    }
  }
  ...
  return (
    <section className="bg-gray-900 py-20" id="awards">
      <Container>
        <div className="mx-auto max-w-4xl">
          {/* Section Header */}
          <div className="mb-12 flex items-center gap-4">
            <BsTrophy className="text-3xl text-blue-400" />
            <h2 className="text-4xl font-bold text-white">Recognition</h2>
          </div>
